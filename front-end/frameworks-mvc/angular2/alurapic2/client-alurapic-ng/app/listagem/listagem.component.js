...
var ListagemComponent = (function () {
    ...
    ListagemComponent.prototype.remove = function (foto) {
        ...
        this._fotoService
            ...
            var novasFotos = _this._fotos.slice();
            var indice = novasFotos.indexOf(foto);
            novasFotos.splice(indice, 1);
            _this._fotos = novasFotos;
            _this._mensagem = "Foto " + foto.titulo + " removida com sucesso";
        }, function (error) {
            console.error(error);
            _this._mensagem = 'Foto removida com sucesso';
        });
    };
